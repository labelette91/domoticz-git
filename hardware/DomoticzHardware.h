...
protected:
	...
	void SendTempHumSensor(const int NodeID, const int BatteryLevel, const float temperature, const int humidity, const std::string &defaultname, const int RssiLevel = 12 , int psubtype= sTypeTH5 );
	...
	void SendSwitchRaw(const int NodeID, const int ChildID, const int BatteryLevel, const bool bOn, const double level, const std::string &defaultname, const int RssiLevel =12 );
