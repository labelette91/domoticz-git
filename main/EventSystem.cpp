...
//************* create variable 
// syntax VALUE CREATE [INTEGER/FLOAT/STRING/DATE/TIME] [STATIC]
// if STATIC is present , variable is created in local RAM area and will be deleted at restart
// this avoid database access in order to stored LUA local variable
// if STATIC is not present , variable is created in DATABASE in user Variable
